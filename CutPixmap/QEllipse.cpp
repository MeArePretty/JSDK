...
QEllipse::QEllipse(QPen pen, QColor Foreground, QColor Background, Qt::PenStyle PenStyle, bool frame, bool hollow):
...
void QEllipse::Draw(QPainter * m_Painter)
{
	if (Frame)
	{
...
void QEllipse::EghiteAngle(int Width)
{
...
bool QEllipse::MouseInside(QPoint point)
{
	 return m_Rect.contains(point);;
}

void QEllipse::DrawRectCut()
{
...
void QEllipse::CursorPos(QPoint * point)
{
...
void QEllipse::Copy(void * layer)
{
	memcpy(this, (QEllipse*)layer, sizeof(QEllipse));
}

void QEllipse::MoveCurrentRect(QPoint point)
{
	//switch (m_CurPos)
	//{
...
void QEllipse::CenterPoint(QPoint point)
{
