...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyCombox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyCombox_t qt_meta_stringdata_MyCombox = {
    {
QT_MOC_LITERAL(0, 0, 8), // "MyCombox"
QT_MOC_LITERAL(1, 9, 17), // "LineStatusChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12), // "Qt::PenStyle"
QT_MOC_LITERAL(4, 41, 12), // "IndexChanged"
QT_MOC_LITERAL(5, 54, 5) // "index"

    },
    "MyCombox\0LineStatusChanged\0\0Qt::PenStyle\0"
    "IndexChanged\0index"
};
...
void MyCombox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->LineStatusChanged((*reinterpret_cast< Qt::PenStyle(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyCombox::*_t)(Qt::PenStyle );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyCombox::LineStatusChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyCombox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_MyCombox.data,
      qt_meta_data_MyCombox,  qt_static_metacall, nullptr, nullptr}
};
...
void *MyCombox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyCombox.stringdata0))
...
// SIGNAL 0
void MyCombox::LineStatusChanged(Qt::PenStyle _t1)
{
